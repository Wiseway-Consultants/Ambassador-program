...
STRIPE_ACCOUNT_ID = getenv("STRIPE_ACCOUNT_ID")
STRIPE_FINANCIAL_ACCOUNT = getenv("STRIPE_FINANCIAL_ACCOUNT")
STRIPE_FINANCIAL_ACCOUNT_CURRENCY = getenv("STRIPE_FINANCIAL_ACCOUNT_CURRENCY")
